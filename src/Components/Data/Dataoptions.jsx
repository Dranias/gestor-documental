...
export const temas = [
  ...
  { label: 'Desginación de enlace' },
  { label: 'Desginación de funcionario' },
  ...
  { label: 'Obra educativos' },
  { label: 'Obra eduicativa' },
  { label: 'Obra escolar' },
  { label: 'Obra muncipal' },
  ...
  { label: 'Regularización de inmueble' },
...
export const dependencias = [
  ...
  { label: 'Dirección del Instituto Poblano del Deporte' },
  ...
  { label: 'Magistrado Presidente del Consejo de la Judicatura del Poder Judicial del Estado de Puebla' },
  ...
  { label: 'Secretaria Ejecutiva del Sistema de Protección Integral de Niñas, Niños y Adolescentes del Estado de Puebla' },
